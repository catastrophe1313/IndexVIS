...
// var bl=["#6e40aa","#bf3caf","#fe4b83","#ff7847","#e2b72f","#aff05b","#52f667","#1ddfa3","#23abd8","#4c6edb","#6e40aa"]
// var re=["#6e40aa","#aff05b","#e2b72f","#52f667","#23abd8"]
// var gr=['rgb(217,240,163)','rgb(173,221,142)','rgb(120,198,121)','rgb(65,171,93)','rgb(35,132,67)']
// var pu=['rgb(255,221,255)','rgb(221,170,255)']
// var ye=['rgb(255,237,160)','rgb(254,178,76)','rgb(253,141,60)']
// var all = ["#ff5e63","#6e40aa","#417de0","#aff05b","#efa72f","#bfbf00","#00bfbf"];
function hsv(H,V){
  var c=V*0.5//V*S
...
for(var i=0;i<date1.length;i++){
    var temp={}
    temp.index=z[date1[i]].index
    temp.name="总类"
    temp.uncertainty=2.5
    var tt=[]
    for(var j=1;j<z[date1[i]]['children'].length;j++){
      
      tt[j-1]=z[date1[i]]['children'][j]
...
console.log(list)
  ...
  myChart1.on('datazoom',function(params){
    ...
    ST=xAxis.data[xAxis.rangeStart]
    ED=xAxis.data[xAxis.rangeEnd]
    console.log(ST,ED)
  })
 var co=[]
