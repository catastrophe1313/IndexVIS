...
//              var ll=d3.select('#right22body').selectAll('line')['_groups'][0][id]
//              d3.select(ll).attr('x2',x)
//              var len = datalist.length
//              console.log(datalist.length)
//              var tt =d3.select('#right22body').selectAll('text')['_groups'][0][id+len]
//              d3.select(tt).attr('x',x+10)
//              var val2 = d3.select(ll).attr('x2')
//              var val1 = d3.select(ll).attr('x1')
//              var val = 0
//         if(tit == 0){
//                 val = ((val2-val1)/2).toFixed(2)
//                 d3.select(tt).text(val.toString()+'￥')
//             }
//             else if(tit == 1){
//                 val = ((val2-val1)*1.4).toFixed(2)
//                 d3.select(tt).text(val.toString()+'%')
//             }
//             else if(tit == 2){
//                 val = ((val2-val1)/1.4).toFixed(2)
